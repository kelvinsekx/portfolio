...
class Typing extends React.Component{
    componentDidMount(){
        const options ={
            ...
            "ramen", "Ibadan", " two HAUSA girls", "seeing small jokes", "<b style='color:green'>not tweeting</b>", "BEING me", "wine ^(* ! *)^",
            ...
            "<em style='font-size: 0.7em'>Wharton Business School</em>", " INSEAD", "chicago","chicago boothe", "side hustles", "doing vs talking", "my bed",
